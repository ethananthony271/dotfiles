...
-- vim.keymap.set("n", "<leader>ca",   "<cmd>CdProjectAdd<CR>",                        { noremap = true, silent = true,            desc = "Change Working Directory in Tab"     })
-- vim.keymap.set("n", "<leader>ct",   "<cmd>CdProjectTab<CR>",                        { noremap = true, silent = true,            desc = "Add Current Working Directory"       })
-- vim.keymap.set("n", "<leader>cb",   "<cmd>CdProjectBack<CR>",                       { noremap = true, silent = true,            desc = "Switch to Previous Working Directory"})
-- vim.keymap.set("n", "<leader>cm",   "<cmd>CdProjectManualAdd<CR>",                  { noremap = true, silent = true,            desc = "Manually Add Directory"              })
-- vim.keymap.set("n", "<leader>cf",   "<cmd>CdSearchAndAdd<CR>",                      { noremap = true, silent = true,            desc = "Search and Add Directory"            })

-- Git                              
vim.keymap.set("n", "<leader>gh",   "<cmd>Gitsigns preview_hunk<CR>",               { noremap = true, silent = true,            desc = "Preview Hunk"                        })
